...
#include "stb_image.h"
    ...
    const GLfloat vertices[] = {
            ...
            -0.5f, 0.5f, 0.0f, 1.0f, 0.0f, 1.0f,    0.0f, 1.0f, // 左上角
...
//		glUniform4f(vertexColorLocation, 0.0f, grey, 0.0f, 1.0f);
        ...
        glVertexAttribPointer(gTexCoord, 2, GL_FLOAT, GL_FALSE, 8 * sizeof(float), (void*)(6 * sizeof(float)));
    ...
    JNIEXPORT void JNICALL
    Java_com_rolan_opengldemo_tasks_textures04_TexturesWidgetEngine_render(JNIEnv *env,
                                                                           jobject obj) {
        render();
    }
