...
void renderFrame() {
    ...
    glVertexAttribPointer(gvPositionHandle, 2, GL_FLOAT, GL_FALSE, 0, gTriangleVertices);//将顶点位置数据传送进渲染管线, 为画笔指定定点的位置数据
...
extern "C" {
    JNIEXPORT void JNICALL Java_com_rolan_opengldemo_tasks_triangle01_TriangleWidgetEngine_init(JNIEnv * env, jobject obj,  jint width, jint height);
    JNIEXPORT void JNICALL Java_com_rolan_opengldemo_tasks_triangle01_TriangleWidgetEngine_step(JNIEnv * env, jobject obj);
};
