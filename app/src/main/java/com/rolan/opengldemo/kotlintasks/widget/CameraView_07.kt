...
class CameraView_07(context: Context?) : BaseOpenGLKotlinView(context) {
...
//					"   gl_PointSize = 100;\n"+   //设置点的大小
    ...
    override fun onMove(angle: Float, x: Float, y: Float) {
        super.onMove(angle, x, y)
//        Matrix.rotateM(mMVPMatrix, 0, angle, 0f, 0f, 1.0f)//旋转
        Matrix.setLookAtM(mMatrixCamera, 0, x/100, y/100, 5.0f, 0f, 0f, 0f, 0f, 1.0f, 0.0f) //设置相机位置
